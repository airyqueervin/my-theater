angular.module('crisis-center', ['dialog'])
  ...
  .component('crisisCenter', {
    template: '<h2>Now Playing</h2><ng-outlet></ng-outlet>',
    $routeConfig: [
  ...
  .component('crisisList', {
    template:
      ...
      '     <span>|<a ng-href="{{crisis.url}}">Watch {{crisis.name}} Trailer </a></span>\n' +
      '  </li>\n' +
      '</ul>\n',
    bindings: { $router: '<' },
...
function CrisisService($q) {
  var crisesPromise = $q.resolve([
    {id: 1, name: 'Logan', url: 'https://www.youtube.com/watch?v=DekuSxJgpbY'},
    {id: 2, name: 'Hidden Figuers', url: 'https://www.youtube.com/watch?v=RK8xHq6dfAo'},
    {id: 3, name: 'The Lego Batman Movie', url: 'https://www.youtube.com/watch?v=rGQUKzSDhrg'},
    {id: 4, name: 'John Wick 2', url: 'https://www.youtube.com/watch?v=ChpLV9AMqm4'}
  ]);
